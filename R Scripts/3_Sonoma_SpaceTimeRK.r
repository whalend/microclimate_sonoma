...
##BIAS
#-mean(r4$TempC.RK.res,na.rm=T)
##COR
#cor(r4$TempC.RK, r4$TempC, use="pairwise.complete.obs")
##ME
#mean(r4$TempC.RK.res, na.rm=TRUE)
##MSE
#mean(r4$TempC.RK.res^2 , na.rm=TRUE)
##COR_RESID
#correlation predicted and residual, ideally 0
#cor(r4$TempC.RK[!is.na(r4$TempC.RK.res)], r4$TempC.RK.res[!is.na(r4$TempC.RK.res)])
